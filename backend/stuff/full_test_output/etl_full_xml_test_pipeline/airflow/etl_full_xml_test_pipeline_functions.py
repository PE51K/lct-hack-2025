"""
Task Functions Module for Full XML Test Pipeline

Содержит все функции для выполнения ETL задач.
Генерировано автоматически: 2025-09-30T22:03:49.878752
"""
...
def load_to_postgres(**context):
    ...
    - Размер батча: 5000
    - Целевая таблица: public.Full XML Test Pipeline_data
    """
