"""
Task Functions Module for Simple XML Test

Содержит все функции для выполнения ETL задач.
Генерировано автоматически: 2025-09-30T22:02:19.314318
"""
...
# Импорт конфигурации
from etl_simple_xml_test_config import *
...
def transform_data(**context):
    ...
    Применяемые трансформации:
        # - Flatten XML Structure: flatten_xml_to_columns(xml_content)
    # - Extract Coordinates: extract_coordinates_from_spatial(spatial_elements)
    """
...
def load_to_postgres(**context):
    ...
    - Размер батча: 5000
    - Целевая таблица: public.Simple XML Test_data
    """
