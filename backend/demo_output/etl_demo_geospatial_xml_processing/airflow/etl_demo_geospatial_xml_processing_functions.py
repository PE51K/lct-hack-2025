"""
Task Functions Module for Demo Geospatial XML Processing

Содержит все функции для выполнения ETL задач.
Генерировано автоматически: 2025-09-30T20:33:21.706965
"""
...
def load_to_postgres(**context):
    ...
    - Размер батча: 5000
    - Целевая таблица: public.Demo Geospatial XML Processing_data
    """
